...
class UploadDisplayController extends UploadImageController
{
    protected $filePathSettingKey = 'gtdxyz-logo-boost-display_path';

    protected $filenamePrefix = 'gtdxyz-logo-boost-display';
